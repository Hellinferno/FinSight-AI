...
export const LandingPage: React.FC<LandingProps> = ({ onEnter }) => {
  return (
    <div className="min-h-screen bg-slate-900 text-white overflow-hidden relative selection:bg-emerald-500/30 flex flex-col">
      ...
      {/* Hero Section */}
      <main className="relative z-10 max-w-7xl mx-auto px-8 pt-10 pb-20 md:pt-20 md:pb-32 text-center lg:text-left lg:flex items-center justify-between gap-12 w-full">
        <div className="lg:w-1/2 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
                ...
                <button onClick={onEnter} className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-8 py-4 rounded-xl font-medium text-lg transition-all border border-slate-700">
                    Watch Demo
                </button>
            </div>
        ...
        <div className="hidden lg:block lg:w-1/2 mt-16 lg:mt-0 relative group">
      ...
      {/* Feature Grid */}
      <section className="bg-slate-950 py-24 border-t border-slate-800 mt-auto">
