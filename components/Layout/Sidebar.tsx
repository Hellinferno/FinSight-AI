            ...
            {user ? (
               <div className="mb-4 glass-panel p-3 rounded-xl">
                 <div className="flex items-center gap-3 mb-3 px-2">
                    <div className="w-8 h-8 rounded-full bg-emerald-900/50 text-emerald-200 flex items-center justify-center text-xs font-bold border border-emerald-500/30">
                 ...
                 <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-slate-800/50 hover:bg-rose-900/20 text-slate-400 hover:text-rose-400 rounded-lg text-xs transition-colors"
                 >
